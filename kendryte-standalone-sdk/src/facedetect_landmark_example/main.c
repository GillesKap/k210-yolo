...
//        region_layer_draw_boxes(&detect_rl1, drawboxes);
        ...
        /*
         * Deze code zou de boxes moeten tekenen op de lcd -- niet kunnen testen
         */
...
//        region_layer_draw_boxes(&detect_rl1, drawboxes);
        ...
        /*
         * Hieronder -- facedetect landmark originele code  code
         */
//        // copy data over to pred_box, pred_landm, pred_clses
