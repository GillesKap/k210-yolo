...
import yolov3_core.common as common
import yolov3_core.backbone as backbone
from yolov3_core.config import cfg
...
def compute_loss(pred, conv, label, bboxes, i=0):
    ...
    conv = tf.reshape(conv, (-1, output_size, output_size, 3, 5 + NUM_CLASS))
